...
/**
*   Example of use
*   You can use both keyboard an mouse from a single object through prototypes.
*   To initialize a keyboard listner, you just create a new instance of the prototype
*   of InputController.keyboard.
*   --- var keyboard = new InputController.keyboard();
*   --- if (keyboard.LEFT) --- checks if the LEFT keyboard constant is pressed.
*
*/
...
InputController.keyboard.prototype = {
...
InputController.mouse.prototype = {
      onMouseChange: function(event, pressed) {
